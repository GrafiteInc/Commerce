            ...
            @if (StoreHelper::subscriptionPlan($subscription))
                <tr>
                    ...
                    <td class="text-right">
                        ...
                        <a class="btn btn-xs btn-default pull-right" href="{!! route('quarx.plans.edit', [StoreHelper::subscriptionPlan($subscription)->id]) !!}"><i class="fa fa-pencil"></i> Review Plan</a>
                    </td>
                </tr>
            @endif
        @endforeach
