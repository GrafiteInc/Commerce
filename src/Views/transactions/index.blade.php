...
@section('content')
    ...
    <div class="row">
        <div class="raw-m-hide pull-right">
            {!! Form::open(['url' => config('cms.backend-route-prefix', 'cms').'/transactions/search']) !!}
        ...
        @else
            <table class="table table-striped">
                ...
                @foreach($transactions as $transaction)
                    <tr>
                        <td><a href="{!! route(config('cms.backend-route-prefix', 'cms').'.transactions.edit', [$transaction->id]) !!}">{!! $transaction->uuid !!}</a></td>
                        ...
                        <td class="text-right">
                            <a class="btn btn-xs btn-default pull-right" href="{!! route(config('cms.backend-route-prefix', 'cms').'.transactions.edit', [$transaction->id]) !!}"><i class="fa fa-pencil"></i> Edit</a>
                        </td>
                    </tr>
                @endforeach
                </tbody>
