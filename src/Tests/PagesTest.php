...
class PagesTest extends TestCase
{
    ...
    public function setUp()
    {
        ...
        factory(\Mlantz\Hadron\Models\Pages::class)->create();
    }
    ...
    */
    ...
    {
        $pages = factory(\Mlantz\Hadron\Models\Pages::class)->make([ 'id' => 4 ]);
    ...
    {
        $pages = (array) factory(\Mlantz\Hadron\Models\Blog::class)->make([ 'id' => 3, 'title' => 'dumber' ]);
