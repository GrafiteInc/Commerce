...
class WidgetsTest extends TestCase
{
    ...
    public function setUp()
    {
        ...
        factory(\Mlantz\Hadron\Models\Widgets::class)->create();
    }
    ...
    */
    ...
    {
        $widgets = factory(\Mlantz\Hadron\Models\Widgets::class)->make([ 'id' => 4 ]);
    ...
    {
        $widgets = (array) factory(\Mlantz\Hadron\Models\Widgets::class)->make([ 'id' => 3, 'answer' => 'dumber question' ]);
