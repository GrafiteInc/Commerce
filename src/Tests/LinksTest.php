...
class LinksTest extends TestCase
{
    ...
    public function setUp()
    {
        ...
        factory(\Mlantz\Hadron\Models\Links::class)->create();
        factory(\Mlantz\Hadron\Models\Links::class)->make([ 'id' => 1 ]);
    }
    ...
    */
    ...
    {
        $link = factory(\Mlantz\Hadron\Models\Links::class)->make([ 'id' => 89 ]);
