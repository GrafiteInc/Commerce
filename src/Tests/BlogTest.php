...
class BlogTest extends TestCase
{
    ...
    {
        parent::setUp();
        factory(\Mlantz\Hadron\Models\Blog::class)->create();
    }
    ...
    */
    ...
    {
        $blog = (array) factory(\Mlantz\Hadron\Models\Blog::class)->make([ 'id' => 2 ]);
    ...
    {
        $blog = (array) factory(\Mlantz\Hadron\Models\Blog::class)->make([ 'id' => 3, 'title' => 'dumber' ]);
