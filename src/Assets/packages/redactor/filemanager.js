...
RedactorPlugins.filemanager = function()
{
	return {
		getTemplate: function()
        {
            ...
            + '<input class="raw-padding-12 raw90" id="filemanager-filter" placeholder="filer" />'
		...
		load: function()
		{
			$.ajax({
				...
				cache: false,
				headers: {
					Authorizationtoken: _quarxAPIToken
				},
				...
				success: $.proxy(function(data)
				{
					...
					{
						var file = $('<div class="list-row raw-left raw100"><div class="raw50 raw-left"><p><span class="icon-download raw-margin-right-12"></span><a class="file-link" href="#" data-url="'+ _quarxRootURL+'download/file/'+val.file_identifier +'">' + val.file_name + '</a></p></div><div class="raw50 raw-left"><p class="raw-right raw-padding-right-12">'+val.file_date+'</p></div></div>');
